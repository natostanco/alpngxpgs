...
make -j 4 LDFLAGS="-Wl,--gc-sections" CFLAGS=" -march=native -D_GNU_SOURCE -fPIC -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections  " CXXFLAGS=" -march=native -D_GNU_SOURCE -flto -fPIC -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections"
sudo make install
...
cd src/
make -j 4 BUILDTYPE=Release LDFLAGS="-Wl,--gc-sections" CXXFLAGS="-I/usr/include/apr-1 -I/home/b/libpng-$LPNG_VERSION -fPIC -D_GLIBCXX_USE_CXX11_ABI=0 -march=native -D_GNU_SOURCE -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections " CFLAGS=" -I/usr/include/apr-1 -I/home/b/libpng-$LPNG_VERSION -fPIC -D_GLIBCXX_USE_CXX11_ABI=0 -march=native -D_GNU_SOURCE -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections" 
cd pagespeed/automatic/

make -j 4 psol BUILDTYPE=Release LDFLAGS="-Wl,--gc-sections" CXXFLAGS=" -I/usr/include/apr-1 -I/home/b/libpng-$LPNG_VERSION -fPIC -D_GLIBCXX_USE_CXX11_ABI=0 -march=native -D_GNU_SOURCE -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections" CFLAGS="-I/usr/include/apr-1 -I/home/b/libpng-$LPNG_VERSION -fPIC -D_GLIBCXX_USE_CXX11_ABI=0 -march=native -D_GNU_SOURCE -Os -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections"
...
--with-cc-opt="-flto -fPIC -I /usr/include/apr-1 -D_GNU_SOURCE -Os -ffast-math -ffunction-sections -fdata-sections" \
--with-ld-opt="-Wl,--gc-sections -luuid -lapr-1 -laprutil-1 -licudata -licuuc -L$pkgdir/usr/lib -lpng12 -lturbojpeg -ljpeg"
make -j 4
